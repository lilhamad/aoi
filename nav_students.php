       ...
       <div class="row">
            <?php while($roca=mysql_fetch_array($sqca)){ $catid=$roca['category_id']; ?>
				...
				<?php } ?>
               	...
               	<li><a href="index.php" class="drop-down">Register</a>

		<li><a href="#" class="drop-down">Knowledge hall</a>
		
		</li><!-- End Item -->
        
		<li><a href="#" class="nodrop-down">Library</a></li>
        
      

        <li><a href="#" class="drop-down">Contacts</a></li>
        <li><a href="about.php" class="drop-down">About</a></li>
        <li><a href="#" class="drop-down">Testimonial</a></li>
